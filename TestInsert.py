...
def testInsertABR(testInsertStart):
    ...
    print "\n", "=" * 100
    print "First array: heights of Binary Search Trees for ordered elements."
    print "Second array: time to insert a larger element than any other already in the tree."
    print "Columns: ranges [30, 1500, 1000000000]. "
    print "Lines: elements [10, 50, 1000, 3000]"
    print "=" * 100, "\n"
    ...
    for p in elementsOrderedABR:
        ...
        resultTimerOrderedABR.append(timerABR)
        print heightABR
        print timerABR
        print
        heightABR = []
...
def testInsertRB(testInsertStart):
    ...
    for p in elements:
        ...
        resultTimerOrderedRB.append(timerRB)
        print heightRB
        print timerRB
        print
        heightRB = []
